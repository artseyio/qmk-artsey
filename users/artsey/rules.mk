...
ifdef ARTSEY_TOG_USR_1
	OPT_DEFS += -DARTSEY_TOG_USR_1=$(ARTSEY_TOG_USR_1)
else
	OPT_DEFS += -DARTSEY_TOG_USR_1=KC_NO
endif
ifdef ARTSEY_TOG_USR_2
	OPT_DEFS += -DARTSEY_TOG_USR_2=$(ARTSEY_TOG_USR_2)
else
	OPT_DEFS += -DARTSEY_TOG_USR_2=KC_NO
endif
ifdef ARTSEY_TOG_USR_3
	OPT_DEFS += -DARTSEY_TOG_USR_3=$(ARTSEY_TOG_USR_3)
else
	OPT_DEFS += -DARTSEY_TOG_USR_3=KC_NO
endif
ifdef ARTSEY_TOG_USR_4
	OPT_DEFS += -DARTSEY_TOG_USR_4=$(ARTSEY_TOG_USR_4)
else
	OPT_DEFS += -DARTSEY_TOG_USR_4=KC_NO
endif
...
ifeq ($(KEYBOARD), $(filter $(KEYBOARD), draculad ferris/sweep minidox/rev1))
