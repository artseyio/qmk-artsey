...
const uint16_t PROGMEM artsey_7[] = {NUM_1_4,NUM_1_3,COMBO_END};
const uint16_t PROGMEM artsey_8[] = {NUM_1_3,NUM_1_2,COMBO_END};
const uint16_t PROGMEM artsey_9[] = {NUM_2_4,NUM_2_3,COMBO_END};
const uint16_t PROGMEM artsey_0[] = {NUM_2_3,NUM_2_2,COMBO_END};
