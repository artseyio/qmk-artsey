...
KC_GESC, LEFT_NUMBERS, KC_W, KC_E, LEFT_PARENTHETICALS, TD(TD_ARTSEY_LEFT), TD(TD_ARTSEY_RIGHT), RIGHT_PARENTHETICALS, KC_I, KC_O, RIGHT_NUMBERS, KC_BSPC, \
KC_TAB, LEFT_CUSTOM, KC_S, KC_D, LEFT_SYMBOLS, KC_G, KC_H, RIGHT_SYMBOLS, KC_K, KC_L, RIGHT_CUSTOM, KC_ENT, \
